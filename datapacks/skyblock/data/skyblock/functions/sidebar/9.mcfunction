...
execute if score Time(Ticks): skyblock-clock matches 3000..3999 run function skyblock:clock/9am
execute if score Time(Ticks): skyblock-clock matches 4000..4999 run function skyblock:clock/10am
execute if score Time(Ticks): skyblock-clock matches 5000..5999 run function skyblock:clock/11am
execute if score Time(Ticks): skyblock-clock matches 6000..6999 run function skyblock:clock/12pm
execute if score Time(Ticks): skyblock-clock matches 7000..7999 run function skyblock:clock/1pm
execute if score Time(Ticks): skyblock-clock matches 8000..8999 run function skyblock:clock/2pm
execute if score Time(Ticks): skyblock-clock matches 9000..9999 run function skyblock:clock/3pm
...
execute if score Time(Ticks): skyblock-clock matches 22000..22999 run function skyblock:clock/4am
execute if score Time(Ticks): skyblock-clock matches 23000..23999 run function skyblock:clock/5am
