...
# ════ Collections ════ #
execute if entity @a[tag=!collected_wood,scores={oak_log_mined=1}] run function skyblock:collections/first-time
execute if entity @a[tag=!collected_wood,scores={oak_wood_mined=1}] run function skyblock:collections/first-time
...
# 0 "Start"
execute if entity @a[scores={quest_id=0}] run function skyblock:quests/01/start
